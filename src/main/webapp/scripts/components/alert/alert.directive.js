        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('jjzjhipsterswaggerApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-jjzjhipsterswaggerApp-error');
                                var entityKey = httpResponse.headers('X-jjzjhipsterswaggerApp-params');
                                if (errorHeader) {
                                    ...
                                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                                        ...
                                        var fieldName = $translate.instant('jjzjhipsterswaggerApp.' + fieldError.objectName + '.' + convertedField);
